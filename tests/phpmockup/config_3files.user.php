<?php if(realpath(__FILE__)===realpath($_SERVER["SCRIPT_FILENAME"])){header($_SERVER["SERVER_PROTOCOL"]." 404 Not Found");die();}?>
{
	"globals": {
		...
		"_remove_me_to_set_DEFAULT_USER_CONFIGURATION_DIR" : "config.user.d",
		"_remove_me_to_set_DEFAULT_CONFIG_USER_FILENAME"   : "config.user.json",
		"_remove_me_to_set_DEFAULT_CONFIG_PASSWD_FILENAME" : "passwd.user.php"
	},
